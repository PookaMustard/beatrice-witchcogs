...
class pokemon:
    ...
    async def pokedex(self, ctx):
        """Sends the entire Pokédex in a PM"""
        ...
        await self.bot.say("Check your private messages for the Pokédex entries.")

    @commands.command()
    async def pokemon(self, inte=''):
        """Returns a random or selected Pokemon image. (Put a Pokédex number or a Pokémon's name after the command to select a Pokémon)"""
        pokemonran = [
        ...
        try:
            ...
            while (i <= 720):
                if inte.lower() in pokemonran[i].lower():
                    ...
                    i=i+1
            return await self.bot.say("Pokémon not found, or invalid Pokédex entry number entered. Please enter a valid Pokémon name or Pokédex entry number.")
        if inte==600613600613:
            ...
            return await self.bot.say("There are no negative Pokédex entries. Enter a positive Pokédex entry number, or a full Pokémon name.")
        elif (inte==0):
            return await self.bot.say("There is no Pokédex entry at #0000. Try a number higher than zero, or enter a full Pokémon name")
        else:
